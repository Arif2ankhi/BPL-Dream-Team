...
const Banner = ({handleClaimCoin}) => {
    ...
    <header className="w-9/12 mx-auto">
        ...
        >
            ...
            <h1 className="text-2xl font-bold text-white mt-2">Assemble Your Ultimate Dream 11 Cricket Team</h1>
            <p className="font-semibold text-lg text-gray-400 mt-2">Beyond Boundaries Beyond Limits</p>
